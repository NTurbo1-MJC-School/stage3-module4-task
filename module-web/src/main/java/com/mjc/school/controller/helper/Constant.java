...
public class Constant {
  ...
  public static final String NEWS_IDS_ENTER = "Enter news ids separated by comma! (enter null if no news id):";
  ...
  public static final String TAG_IDS_ENTER = "Enter tag ids separated by comma! (enter null if no tag id):";
